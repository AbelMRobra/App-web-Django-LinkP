...
def presupuesto_auditor(request):
    ...
    if request.method=='POST':
        ...
        #auditor_presupuesto_p(proyecto,fecha_desde, fecha_hasta)
   
            
    return render(request, "presupuestos/presupuesto_auditor.html",{'data_resultante':data_resultante,'proyectos':proyectos,'mensaje':mensaje})
