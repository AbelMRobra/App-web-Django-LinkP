...
class ProyectosTercerosResource(resources.ModelResource):
    class Meta:
        model = ProyectosTerceros

class ProyectosTercerosAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ('nombre','m2', 'descrip')
    search_fields = ('nombre','m2', 'descrip')
    resources_class = ProyectosTercerosResource
...
admin.site.register(ProyectosTerceros, ProyectosTercerosAdmin)
