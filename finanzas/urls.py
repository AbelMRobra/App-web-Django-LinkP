...
from . import views
from .views import DescargarCuentacorriente, DescargarTotalCuentas, PdfPrueba
...
urlpatterns = [
    ...
    url(r'^totalcuentas$', login_required(views.cuentacte_resumen), name = 'Resumen de cuentas'),
