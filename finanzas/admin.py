...
class HonorariosResource(resources.ModelResource):
    class Meta:
        model = Honorarios

class HonorariosAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ['fecha']
    search_fields = ['fecha']
...
admin.site.register(Honorarios, HonorariosAdmin)
